<?php
	...
	else if($package_type == "label_1_kg"){
		$box_type_cost = $box_type_cost_1_kg;
	} else if($package_type == "label_3_kg"){
		$box_type_cost = $box_type_cost_3_kg;
	} else if($package_type == "label_5_kg"){
		$box_type_cost = $box_type_cost_5_kg;
	} else if($package_type == "label_10_kg"){
		$box_type_cost = $box_type_cost_10_kg;
	} else if($package_type == "label_20_kg"){
